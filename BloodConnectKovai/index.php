...
<html>
  ...
  <body>
    ...
    <div class="container">
     ...
     <div class="list">
      <a href="login.php"><h1>Donor Login</h1></a>
</div>
    </div>
    <br>
    <div class="slogan">
    ...
    <div class="bb">
      <br><br>
    <a href="donors.php"><button class="button" style="vertical-align:middle"><span>Donor Availability Search </span></button></a>
    <a href="bloodbank.html"><button class="button" style="vertical-align:middle"><span>Blood Bank List </span></button></a>
    <a href="logon.php"><button class="button" style="vertical-align:middle"><span>Become a donor </span></button></a>
    <br><br><br><br>
  </div>
            <br><br>
            ...
            <div class="contain">
              ...
              <div class="list1">
                <a href="donors.php"><p>Blood Availability</p></a>
                <a href="bloodbank.html"><p>Blood Bank List</p></a>
                <a href="login.php"><p>Become a Donor</p></a>
              </div>
            </div>
            <br>
            </center>
