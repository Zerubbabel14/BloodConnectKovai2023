...
<html>
    ...
    <body>
    <a href="lloginpath.php"> <img src="home.png" width="30" height="30"></a>
        
    <center>
        <br>
        <h2  style="font-family: arial black;">Admin Panel</h2>
        <br><br>
        <form method="POST">
        <table style="width: 70%;height: 40%;">
            <tr style="height:40px">
                <th colspan="3" style="background-color: rgb(204, 33, 33);font-family: arial black;"><div>
                <input style="text-align:center" type="text" id="name" name="name" readonly>
            </div><br> </th>
            </tr>
            ...
            <tr>
                <td>A +ve</td>
                <td><input style="text-align:center" type="number" id="ap" name="ap"  ></td>
            </tr>
            <tr>
                <td>A -ve</td>
                <td><input style="text-align:center" type="number" id="an" name="an" ></td>
            </tr>
            <tr>
                <td>B +ve</td>
                <td><input style="text-align:center" type="number" id="bp" name="bp" ></td>
            </tr>
            <tr>
                <td>B -ve</td>
                <td><input style="text-align:center" type="number" id="bn" name="bn" ></td>
            </tr>
            <tr>
                <td>AB +ve</td>
                <td><input style="text-align:center" type="number" id="abp" name="abp" ></td>
            </tr>
            <tr>
                <td>AB -ve</td>
                <td><input  style="text-align:center" type="number" id="abn" name="abn" ></td>
            </tr>
            <tr>
                <td>O +ve</td>
                <td><input style="text-align:center" type="number" id="op" name="op" ></td>
            </tr>
            <tr>
                <td>O -ve</td>
                <td><input style="text-align:center" type="number" id="on" name="on" ></td>
            </tr>
    ...
    if (isset($_POST['save'])) {
        ...
        $sql1 = "UPDATE `bloodbank` SET `unit`='$ap' WHERE `bloodgroup`='A +ve' AND `bbid`='$a'";
        $sql2 = "UPDATE `bloodbank` SET `unit`='$an' WHERE `bloodgroup`='A -ve' AND `bbid`='$a'";
        $sql3 = "UPDATE `bloodbank` SET `unit`='$bp' WHERE `bloodgroup`='B +ve' AND `bbid`='$a'";
        $sql4 = "UPDATE `bloodbank` SET `unit`='$bn' WHERE `bloodgroup`='B -ve' AND `bbid`='$a'";
        $sql5 = "UPDATE `bloodbank` SET `unit`='$abp' WHERE `bloodgroup`='AB +ve' AND `bbid`='$a'";
        $sql6 = "UPDATE `bloodbank` SET `unit`='$abn' WHERE `bloodgroup`='AB -ve' AND `bbid`='$a'";
        $sql7 = "UPDATE `bloodbank` SET `unit`='$op' WHERE `bloodgroup`='O +ve' AND `bbid`='$a'";
        $sql8 = "UPDATE `bloodbank` SET `unit`='$on' WHERE `bloodgroup`='O -ve' AND `bbid`='$a'";
        ...
        header('Location: bloodbank.html');
    }
