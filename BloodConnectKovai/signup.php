      ...
      <a href="index.php"><img src="home.png"></a>
        <center>
            ...
            <div class="user-input-wrp">
              ...
              <div class="user-input-wrp">
                <br/>
                <input type="text" class="inputText" id="t1" name="mobile" minlength="10" maxlength="10" required/>
...
if(isset($_POST['sign_Btn'])){
    ...
    {
      $query = "insert into bck.signup(name,email,mobile,password,repassword) values('$name','$email','$mobile','$password','$repassword')";
